...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectAvailableLayer'
        db.create_table(u'orm_projectavailablelayer', (
            ...
            ('up_branch', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['orm.Branch'], null=True)),
            ...
            ('dirpath', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True)),
            ('priority', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('local_path', self.gf('django.db.models.fields.FilePathField')(default='/', max_length=1024)),
        ))
        db.send_create_signal(u'orm', ['ProjectAvailableLayer'])


    def backwards(self, orm):
        # Deleting model 'ProjectAvailableLayer'
        db.delete_table(u'orm_projectavailablelayer')
