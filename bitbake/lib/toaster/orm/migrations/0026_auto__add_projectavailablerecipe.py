...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectAvailableRecipe'
        db.create_table(u'orm_projectavailablerecipe', (
            ...
            ('pathflags', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ...
            ('available_layer', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['orm.ProjectAvailableLayer'], null=True)),
        ))
        db.send_create_signal(u'orm', ['ProjectAvailableRecipe'])


    def backwards(self, orm):
        # Deleting model 'ProjectAvailableRecipe'
        db.delete_table(u'orm_projectavailablerecipe')
