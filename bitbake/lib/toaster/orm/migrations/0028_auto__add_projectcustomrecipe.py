...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectCustomRecipe'
        db.create_table(u'orm_projectcustomrecipe', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('base_recipe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orm.ProjectAvailableRecipe'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orm.Project'])),
        ))
        db.send_create_signal(u'orm', ['ProjectCustomRecipe'])

        # Adding M2M table for field packages on 'ProjectCustomRecipe'
        m2m_table_name = db.shorten_name(u'orm_projectcustomrecipe_packages')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('projectcustomrecipe', models.ForeignKey(orm[u'orm.projectcustomrecipe'], null=False)),
            ('projectavailablepackage', models.ForeignKey(orm[u'orm.projectavailablepackage'], null=False))
        ))
        db.create_unique(m2m_table_name, ['projectcustomrecipe_id', 'projectavailablepackage_id'])


    def backwards(self, orm):
        # Deleting model 'ProjectCustomRecipe'
        db.delete_table(u'orm_projectcustomrecipe')

        # Removing M2M table for field packages on 'ProjectCustomRecipe'
        db.delete_table(db.shorten_name(u'orm_projectcustomrecipe_packages'))
    ...
    models = {
        ...
        u'orm.projectavailablelayer': {
            'Meta': {'object_name': 'ProjectAvailableLayer'},
            'branch': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'build': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['orm.Build']", 'null': 'True'}),
            'commit': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'dirpath': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'orm.projectavailablepackage': {
            'Meta': {'object_name': 'ProjectAvailablePackage'},
            'available_recipe': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['orm.ProjectAvailableRecipe']", 'null': 'True'}),
            'build': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['orm.Build']", 'null': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'installed_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'}),
        ...
        u'orm.projectavailablerecipe': {
            'Meta': {'object_name': 'ProjectAvailableRecipe'},
            'available_layer': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['orm.ProjectAvailableLayer']", 'null': 'True'}),
        ...
        u'orm.projectcustomrecipe': {
            'Meta': {'object_name': 'ProjectCustomRecipe'},
            'base_recipe': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['orm.ProjectAvailableRecipe']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'packages': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['orm.ProjectAvailablePackage']", 'symmetrical': 'False'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['orm.Project']"})
        },
        u'orm.projectlayer': {
