...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ProjectCustomRecipe', fields ['name', 'project']
        db.create_unique(u'orm_projectcustomrecipe', ['name', 'project_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProjectCustomRecipe', fields ['name', 'project']
        db.delete_unique(u'orm_projectcustomrecipe', ['name', 'project_id'])
    ...
    models = {
        ...
        u'orm.projectcustomrecipe': {
            'Meta': {'unique_together': "(('name', 'project'),)", 'object_name': 'ProjectCustomRecipe'},
