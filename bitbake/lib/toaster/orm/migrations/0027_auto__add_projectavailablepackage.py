...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectAvailablePackage'
        db.create_table(u'orm_projectavailablepackage', (
            ...
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['orm.Project'], null=True)),
            ('recipe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orm.Recipe'], null=True)),
            ('installed_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ...
            ('build', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['orm.Build'], null=True)),
            ('available_recipe', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['orm.ProjectAvailableRecipe'], null=True)),
        ))
        db.send_create_signal(u'orm', ['ProjectAvailablePackage'])


    def backwards(self, orm):
        # Deleting model 'ProjectAvailablePackage'
        db.delete_table(u'orm_projectavailablepackage')
